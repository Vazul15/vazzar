    ...
    <section className="py-18">
      <div className="w-full pl-6">
        ...
        <div className="w-full">
          <Carousel setApi={setCarouselApiActors} opts={{ dragFree: true }}>
            <CarouselContent className="ml-0">
              {credits.cast.map((actor) => (
                <CarouselItem key={actor.id} className="max-w-[200px] px-2">
        ...
        <div className="w-full">
          <Carousel setApi={setCarouselApiDirectors} opts={{ dragFree: true }}>
            <CarouselContent className="ml-0">
              {credits.crew.map((director) => (
                <CarouselItem key={director.id} className="max-w-[200px] px-2">
                  <div className="group relative flex flex-col items-center">
                    <img
